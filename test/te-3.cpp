...
//
// 목적:
//   ProcessedBuffer에서 PointCloudXYZFrame을 읽어 OccupancyGridBuilder로
//   2D Occupancy Grid를 생성, GridBuffer에 저장, ROS2 토픽 발행, 콘솔 출력
//
// 실행:
...
using route_planner::occupancy_grid::GridBuffer;
...
int main(int argc, char** argv)
{
    ...
    auto grid_buffer      = std::make_shared<GridBuffer>();
